...
type RouteParams = { article_slug: string }
type RouteId = '/(blog)/articles/[article_slug]';
...
type LayoutRouteId = RouteId | "/(blog)/articles/[article_slug]"
type LayoutParams = RouteParams & { article_slug?: string }
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(blog)/articles/[article_slug]/+layout.server.js').load>>>>>>;
